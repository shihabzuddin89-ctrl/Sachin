      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative aspect-[3/4] w-full overflow-hidden rounded-3xl bg-zinc-900 border border-zinc-200/10 shadow-2xl">
              ...
              <motion.div
                ...
                style={{ originY: 0 }}
                className="absolute inset-0 bg-[#E5C158] z-10 pointer-events-none"
              />
            </div>

            <div className="mt-8 space-y-4">
              <span className="text-[0.62rem] font-mono tracking-[0.3em] text-[#E5C158] uppercase block">
                MAIN CREATIVE KIT
              </span>
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div className="p-4 border rounded-xl border-white/10 bg-white/5">
                  <span className="font-bold text-white block">Leica SL2 Duo</span>
                  <span className="text-[0.65rem] text-zinc-300 font-mono font-medium">50mm f/1.4 &middot; 35mm f/2.0</span>
                </div>
                <div className="p-4 border rounded-xl border-white/10 bg-white/5">
                  <span className="font-bold text-white block">Pentax 67 Film</span>
                  <span className="text-[0.65rem] text-zinc-300 font-mono font-medium">105mm f/2.4 &middot; Portra 400</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="space-y-4">
              ...
              <h1 className={`text-4xl md:text-5xl font-light tracking-tight text-white ${config.fontPreset === 'modern-mono' ? 'font-mono' : 'font-serif'}`}>
                Candid frames, <span className="italic font-serif text-[#E5C158]">masterly</span> art directed.
              </h1>
              <div className="w-16 h-[1.5px] bg-[#E5C158]/80 my-4" />
            </div>

            <div className="prose text-sm text-zinc-200 leading-relaxed font-normal space-y-6">
              <p>
                 Hello there, I'm <span className="font-semibold text-[#E5C158]">{config.studioName}</span>. Most couples who step before my lens start by telling me: 
            ...
            <div className="space-y-4 pt-4 border-t border-white/10">
              <span className="text-[0.65rem] font-mono tracking-widest text-[#E5C158] uppercase block mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {corePhilosophy.map((phil, idx) => (
                  <div key={idx} className="space-y-2">
                    <span className="text-[#E5C158] text-xs font-bold font-sans block">
                      0{idx + 1} &middot; {phil.title}
                    </span>
                    <p className="text-[0.68rem] text-zinc-300 leading-relaxed font-sans font-medium">
                      {phil.desc}
                    </p>
                  </div>
                ))}
        ...
        <div className="mb-28">
          <div className="text-center max-w-xl mx-auto space-y-4 mb-20">
            ...
            <h2 className={`text-3xl font-light tracking-tight text-white ${config.fontPreset === 'modern-mono' ? 'font-mono' : 'font-serif'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {years.map((y, index) => (
              <div
                key={index}
                className="p-6 border rounded-2xl border-white/10 bg-white/5 hover:border-[#E5C158]/40 duration-300 transition-all space-y-4"
              >
                <div className="flex justify-between items-baseline">
                  <span className="text-4xl font-light text-[#E5C158] font-sans">{y.year}</span>
                  <span className="text-[0.55rem] font-mono text-white uppercase tracking-widest bg-white/10 px-2.5 py-1 rounded-full font-semibold">
                    {y.tag}
                  </span>
                </div>
                <div className="space-y-1">
                  <h4 className="text-xs font-semibold text-zinc-100 uppercase font-mono tracking-wider">
                    {y.title}
                  </h4>
                  <p className="text-[0.68rem] text-zinc-300 font-medium leading-relaxed">
                    {y.desc}
                  </p>
                </div>
              </div>
        ...
        <div className={`p-8 md:p-12 border rounded-3xl text-center bg-zinc-900 border-zinc-800 text-white relative overflow-hidden flex flex-col items-center justify-center space-y-6`}>
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom,rgba(229,193,88,0.06),transparent_75%)] pointer-events-none" />
          <Compass className="w-8 h-8 text-[#E5C158] animate-spin-slow" />
          
          <div className="space-y-2 max-w-lg relative z-5">
            <span className="text-[0.62rem] font-mono text-[#E5C158] tracking-[0.3em] uppercase block">
          ...
          <button
            ...
            className="px-6 py-3 cursor-pointer bg-[#E5C158] hover:bg-[#F3D17E] text-[#060709] font-sans font-semibold text-xs tracking-widest uppercase rounded-xl transition-all hover:scale-101"
          >
             BOOK TOUR RATES
          </button>
        </div>
