          ...
          {WEDDING_PORTIONS.map((portion, idx) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative flex flex-col justify-end overflow-hidden rounded-3xl bg-zinc-950 shadow-[0_20px_45px_rgba(0,0,0,0.5)] cursor-pointer ${
                  isBig 
                    ? "md:col-span-7 lg:col-span-8 md:row-span-2 min-h-[480px] md:min-h-[620px]"
                    : "md:col-span-5 lg:col-span-4 min-h-[280px] md:min-h-[295px]"
                }`}
                whileHover={{ y: -8 }}
              ...
              >
                ...
                <div className="absolute inset-0 w-full h-full overflow-hidden">
                  <img
                    ...
                    className="w-full h-full object-cover object-center grayscale group-hover:grayscale-0 scale-100 group-hover:scale-[1.03] transition-all duration-[1200ms] ease-out opacity-65 group-hover:opacity-85"
