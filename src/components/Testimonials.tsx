...
export default function Testimonials({ config }: TestimonialsProps) {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10 pt-10 md:pt-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          <FadeUpReveal className="lg:col-span-5 relative w-full flex justify-center lg:justify-start">
          ...
          <FadeUpReveal delay={0.2} className="lg:col-span-7 space-y-8 text-left">
            <div className="space-y-8 text-left">
              <div className="space-y-5">
                ...
                <h2 className="text-5xl sm:text-6xl md:text-7xl font-serif font-light tracking-tight text-white leading-tight">
                  Hi, I'm <span className="font-serif italic font-normal text-[#C5A880] block sm:inline">Sourav Gupta</span>
                </h2>
              </div>
